...
# --- CÓDIGO DO BANNER DE PROPAGANDA ---

st.markdown("---") # Adiciona uma linha divisória para separar o conteúdo

# Título para a seção de propaganda (opcional)
st.markdown("<h4 style='text-align: center; color: #003366;'>Aproveite nossas ofertas!</h4>", unsafe_allow_html=True)
...
st.markdown(f"""
<a href="{link_da_propaganda}" target="_blank">
    <img src="{url_da_imagem_do_banner}" alt="Propaganda" style="width:100%; border-radius: 7px;">
</a>
""", unsafe_allow_html=True)

# --- FIM DO CÓDIGO DO BANNER ---
